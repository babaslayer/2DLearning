...
public class SpawnerTPS : MonoBehaviour
{
    ...
    {
        Gizmos.color = Color.green;//Gizmosa bu ˛ekilde renk at˝yoruz.
        Gizmos.DrawWireCube((minDistance + maxDistance) / 2, maxDistance - minDistance);//DrawCube den fark˝ ise iÁin bo˛ bir kare elde etmektir.
        //k¸p¸n merkezini ve uzunluunu bu ˛elilde belirttik.
    }
